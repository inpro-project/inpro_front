...
export default {
  ...
  methods: {
    ...
    postPortfolio (portfolio) {
      ...
      axios
        .post(process.env.VUE_APP_API_BASE_URL + '/app/portfolios/2', JSON.stringify(data), { headers: { 'Content-Type': 'application/json', Authorization: VueCookies.get('Authorization') } })
        .then(res => {
          console.log(res)
        })
        .catch(err => {
