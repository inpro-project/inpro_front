<template>
    ...
    <div style="display:flex; justify-content: space-between; position:fixed; border-style:solid; border-width:0px; border-color: black; width:100%; min-width:390px; height:95px; bottom:70px; background-color: white;">
      <div style="position:relative; margin-left: 5%; top:10px;" type="button" @click="goBack()">
...
<svg  style="z-index: 99999; position:relative; top:2px; left:-48%" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#1FE13E" class="bi bi-chat-left" viewBox="0 0 16 16">
  <path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
</svg>
      </div>
      <div style="position:relative; margin-right:5%; top:10px;" type="button" @click="deleteLike">
