...
<button style="border:solid; border-radius:10px; border-width:0px; background-color:gray; color:white; width:50%; height:30px" @click="postportfolio">활동 이력 등록</button>
